...
───────────────────────────────────────────────────────────────
*Primary Tumor (pT):
  (_) pTX   (_) pTis  (_) pT1mi  (_) pT1a
  (_) pT1b  (_) pT1c  (_) pT2    (_) pT3    (_) pT4a
  (_) pT4b  (_) pT4c  (_) pT4d
  (_) ypT0 (post-neoadjuvant therapy only - complete pathologic response)
...
+HER2 FISH (if IHC 2+):
  ...
  Average CEP17 signals per cell: ___

  Interpretation (ASCO/CAP 2018):
    (_) POSITIVE (amplified):
        - HER2/CEP17 ratio ≥2.0, OR
        - Average HER2 signals/cell ≥6.0
    (_) NEGATIVE (not amplified):
        - HER2/CEP17 ratio <2.0 AND average HER2 <4.0
    (_) EQUIVOCAL:
        - HER2/CEP17 ratio <2.0 BUT average HER2 ≥4.0 and <6.0 (ISH Group 2)
        - OR HER2/CEP17 ratio ≥2.0 BUT average HER2 <4.0 (ISH Group 4, rare)
        - Recommend: Recount/alternative specimen/IHC correlation

*Ki-67 Proliferation Index: ___% (entire tumor average OR hotspot - specify method)

  Interpretation (St. Gallen consensus):
    - Low: <20%
    - Intermediate: 20-30%
    - High: >30%
