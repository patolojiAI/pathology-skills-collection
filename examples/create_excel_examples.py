...
print("  python scripts/process_skill.py --skill compliance-checker examples/excel/batch_reports.xlsx")
print("\n  # Single structured report")
print("  python scripts/process_skill.py --skill breast-specialist examples/excel/structured_breast.xlsx")
